...
.controller('myListCtrl', ['$rootScope', '$scope', '$window', '$ionicModal', '$firebase', function($rootScope, $scope, $window, $ionicModal, $firebase) {
...
.controller('mapCtrl', ['$scope', '$ionicPopup', '$ionicPlatform', '$rootScope', '$ionicLoading', '$cordovaGeolocation', function($scope, $ionicPopup,$ionicPlatform, $rootScope,$ionicLoading,$cordovaGeolocation) {
...
.controller('newCtrl', ['$rootScope', '$scope', '$window', '$firebase', function($rootScope, $scope, $window, $firebase) {
...
.controller('MyCtrl', ['$scope', '$ionicGesture', '$window', '$interval', function($scope, $ionicGesture, $window, $interval) {
...
.controller('transactionCtrl', ['$scope', '$ionicModal', '$ionicLoading', '$ionicPopup', '$rootScope', '$cordovaCamera', '$ionicPlatform', '$firebase', function($scope,$ionicModal,$ionicLoading,$ionicPopup,$rootScope, $cordovaCamera, $ionicPlatform, $firebase) {
...
.controller('accountCtrl', ['$scope', '$rootScope', '$window', '$state', '$firebase', '$ionicGesture', '$interval', '$ionicModal', '$filter', function($scope,$rootScope, $window, $state, $firebase,$ionicGesture, $interval,$ionicModal,$filter) { 
...
.controller('testCtrl', ['$scope', '$rootScope', '$cordovaCamera', '$ionicPlatform', '$firebase', function($scope,$rootScope, $cordovaCamera, $ionicPlatform, $firebase) {
...
.controller('patternCtrl', ['$scope', 'LoginService', '$ionicPopup', '$state', function($scope, LoginService, $ionicPopup, $state) {
    // 1
...
.controller('alwaysCtrl',  ['$scope', '$rootScope', '$ionicUser', '$ionicPush', function($scope, $rootScope, $ionicUser, $ionicPush) { 
...
.controller('newPassCtrl',  ['$rootScope', '$scope', '$window', '$ionicModal', function($rootScope, $scope, $window, $ionicModal) {
...
.controller('newPass1Ctrl', ['$rootScope', '$scope', '$window', '$ionicModal', function($rootScope, $scope, $window, $ionicModal) {
...
.controller('settingsCtrl', ['$scope', '$window', '$ionicPopup', '$rootScope', '$ionicLoading', '$ionicModal', '$cordovaGeolocation', function($scope,$window, $ionicPopup, $rootScope,$ionicLoading,$ionicModal, $cordovaGeolocation) {
...
.controller('scanCtrl', ['$scope', function($scope) {
...
.controller('notificationCtrl', ['$scope', '$state', function($scope,$state) {
  $scope.locationback = function(){$state.go("menu.overview");
  }
}])

.controller('cardCtrl', ['$scope', '$rootScope', '$http', '$ionicSlideBoxDelegate', '$ionicModal', '$ionicLoading', '$ionicPlatform', function($scope,$rootScope,$http,$ionicSlideBoxDelegate,$ionicModal,$ionicLoading,$ionicPlatform) {
$ionicPlatform.ready(function() {
     $ionicLoading.show({
      template: '<ion-spinner class="ionicspinner spinner-dark" icon="android"></ion-spinner>'
    });
...
console.log(payload);
 ...
 .controller('bluetoothCtrl',['$ionicPopup', '$ionicModal', '$rootScope', '$ionicPlatform', '$scope', '$timeout', function ($ionicPopup,$ionicModal,$rootScope,$ionicPlatform,$scope,$timeout) {
...
.controller('scanCtrl', ['$rootScope', '$scope', '$window', function($rootScope, $scope, $window) {
